...
COPY public."Models" (model_id, name, description, tags, formats, url, min_url, rating, price, uploader_id, materials, currency, category, licence, image_urls) FROM stdin;
9	1	1	{Многосоставная}	\N	1747481777066-Articulated_DRAGON_V3.stl	\N	\N	1	55	{ABS}	USD	Персонажи	MIT	{1747481778944-896265fcd1ff5e40b23ccfdbfb33f53d-imagejpeg.jpg}
\.
...
COPY public."Orders" (order_id, model_id, seller_id, customer_id, price, date, rating) FROM stdin;
\.
...
COPY public."Users" (user_id, login, email, password, mailing) FROM stdin;
55	3	test@test.ru	$2b$10$mb0Zlr91z8rUfPKqKTBqxei/N.rp6hDCWBEym6wOYr6NxK5L2Yspy	t
\.
...
SELECT pg_catalog.setval('public."Models_model_id_seq"', 9, true);
